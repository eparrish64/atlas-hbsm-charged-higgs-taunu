...
#akTAUID_MEDIUM = TCut("tau_0_jet_rnn_medium==1")
...
TAU_TRACKS = {
    ...
    #ak "mc16": TCut("tau_0_n_charged_tracks==1||tau_0_n_charged_tracks==3"),
    #"mc16": TCut("tau_0_n_charged_tracks==1"),
    "mc16": TCut("tau_0_n_charged_tracks==3"),
}
...
ANTI_TAU = TCut("tau_0_jet_rnn_score_trans > 0.02 && tau_0_jet_rnn_loose==0")
