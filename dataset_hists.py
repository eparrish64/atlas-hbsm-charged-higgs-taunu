                ...
                for n, category in enumerate(categories):
                    ...
                    for var in fields:
                        ...
                        if not htmp:
                            ...
                            continue 
                        htmp.SetDirectory(0)
                        ##print histname,var.bins,var.binning,htmp.GetNbinsX() 
                        if var.bins:
                        ...
                        ##print "HERE1",htmp,htmp.GetNbinsX(),hset.hist.GetNbinsX()
                        hset.hist.Add(htmp)
                        ##print "HERE2"
