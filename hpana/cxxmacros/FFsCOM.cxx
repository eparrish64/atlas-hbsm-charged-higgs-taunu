...
float GetFFCombined_NOMINAL(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (2.58*FF_CR_MULTIJET) + (-1.58*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 60) return (-0.53*FF_CR_MULTIJET) + (1.53*FF_CR_WJETS);
			 ...
			 if(pt < 3500) return (3.04*FF_CR_MULTIJET) + (-2.04*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (1.26*FF_CR_MULTIJET) + (-0.26*FF_CR_WJETS);
			 if(pt < 100) return (1.33*FF_CR_MULTIJET) + (-0.33*FF_CR_WJETS);
			 if(pt < 200) return (3.56*FF_CR_MULTIJET) + (-2.56*FF_CR_WJETS);
			 if(pt < 3500) return (0.45*FF_CR_MULTIJET) + (0.55*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (0.69*FF_CR_MULTIJET) + (0.31*FF_CR_WJETS);
			 if(pt < 80) return (0.76*FF_CR_MULTIJET) + (0.24*FF_CR_WJETS);
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-3.22*FF_CR_MULTIJET) + (4.22*FF_CR_WJETS);
			 if(pt < 3500) return (1.26*FF_CR_MULTIJET) + (-0.26*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (0.23*FF_CR_MULTIJET) + (0.77*FF_CR_WJETS);
			 if(pt < 80) return (0.0599999999999*FF_CR_MULTIJET) + (0.94*FF_CR_WJETS);
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (1.71*FF_CR_MULTIJET) + (-0.71*FF_CR_WJETS);
			 if(pt < 3500) return (2.32*FF_CR_MULTIJET) + (-1.32*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 ...
			 if(pt < 60) return (0.6*FF_CR_MULTIJET) + (0.4*FF_CR_WJETS);
			 if(pt < 80) return (0.82*FF_CR_MULTIJET) + (0.18*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (0.58*FF_CR_MULTIJET) + (0.42*FF_CR_WJETS);
	 ...
	 if (index==2002) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.12*FF_CR_MULTIJET) + (2.12*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2007) {
		 if(ntracks==1){
			 if(pt < 40) return (1.1*FF_CR_MULTIJET) + (-0.0999999999999*FF_CR_WJETS);
			 if(pt < 45) return (1.06*FF_CR_MULTIJET) + (-0.0599999999999*FF_CR_WJETS);
			 if(pt < 50) return (0.87*FF_CR_MULTIJET) + (0.13*FF_CR_WJETS);
			 if(pt < 60) return (1.07*FF_CR_MULTIJET) + (-0.0699999999999*FF_CR_WJETS);
			 if(pt < 80) return (1.27*FF_CR_MULTIJET) + (-0.27*FF_CR_WJETS);
			 if(pt < 100) return (1.02*FF_CR_MULTIJET) + (-0.0199999999999*FF_CR_WJETS);
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (0.84*FF_CR_MULTIJET) + (0.16*FF_CR_WJETS);
...
float GetFFCombined_1up(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (3.48*FF_CR_MULTIJET) + (-2.48*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (1.35*FF_CR_MULTIJET) + (-0.35*FF_CR_WJETS);
			 if(pt < 3500) return (3.04*FF_CR_MULTIJET) + (-2.04*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (1.24*FF_CR_MULTIJET) + (-0.24*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 if(pt < 45) return (0.86*FF_CR_MULTIJET) + (0.14*FF_CR_WJETS);
			 if(pt < 50) return (0.79*FF_CR_MULTIJET) + (0.21*FF_CR_WJETS);
			 if(pt < 60) return (0.94*FF_CR_MULTIJET) + (0.0600000000001*FF_CR_WJETS);
			 if(pt < 80) return (1.4*FF_CR_MULTIJET) + (-0.4*FF_CR_WJETS);
			 if(pt < 100) return (1.57*FF_CR_MULTIJET) + (-0.57*FF_CR_WJETS);
			 if(pt < 200) return (3.56*FF_CR_MULTIJET) + (-2.56*FF_CR_WJETS);
			 if(pt < 3500) return (0.88*FF_CR_MULTIJET) + (0.12*FF_CR_WJETS);
			 else return 0;
		 }
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-2.08*FF_CR_MULTIJET) + (3.08*FF_CR_WJETS);
			 if(pt < 3500) return (1.86*FF_CR_MULTIJET) + (-0.86*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (0.28*FF_CR_MULTIJET) + (0.72*FF_CR_WJETS);
			 ...
			 if(pt < 3500) return (1.38*FF_CR_MULTIJET) + (-0.38*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (2.92*FF_CR_MULTIJET) + (-1.92*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 if(pt < 45) return (0.61*FF_CR_MULTIJET) + (0.39*FF_CR_WJETS);
			 if(pt < 50) return (0.61*FF_CR_MULTIJET) + (0.39*FF_CR_WJETS);
			 if(pt < 60) return (0.68*FF_CR_MULTIJET) + (0.32*FF_CR_WJETS);
			 if(pt < 80) return (0.91*FF_CR_MULTIJET) + (0.0900000000001*FF_CR_WJETS);
			 if(pt < 100) return (1.17*FF_CR_MULTIJET) + (-0.17*FF_CR_WJETS);
			 if(pt < 200) return (0.64*FF_CR_MULTIJET) + (0.36*FF_CR_WJETS);
			 if(pt < 3500) return (2.98*FF_CR_MULTIJET) + (-1.98*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (0.6*FF_CR_MULTIJET) + (0.4*FF_CR_WJETS);
			 ...
			 if(pt < 3500) return (0.48*FF_CR_MULTIJET) + (0.52*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2002) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (0.00999999999991*FF_CR_MULTIJET) + (0.99*FF_CR_WJETS);
			 if(pt < 100) return (0.17*FF_CR_MULTIJET) + (0.83*FF_CR_WJETS);
	 ...
	 if (index==2003) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 60) return (-0.1*FF_CR_MULTIJET) + (1.1*FF_CR_WJETS);
			 if(pt < 80) return (0.0199999999999*FF_CR_MULTIJET) + (0.98*FF_CR_WJETS);
			 if(pt < 100) return (0.18*FF_CR_MULTIJET) + (0.82*FF_CR_WJETS);
	 ...
	 if (index==2004) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (0.13*FF_CR_MULTIJET) + (0.87*FF_CR_WJETS);
	 ...
	 if (index==2007) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (0.59*FF_CR_MULTIJET) + (0.41*FF_CR_WJETS);
			 if(pt < 3500) return (0.15*FF_CR_MULTIJET) + (0.85*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (1.22*FF_CR_MULTIJET) + (-0.22*FF_CR_WJETS);
	 ...
	 if (index==2000) {
		 if(ntracks==1){
			 if(pt < 40) return (-0.45*FF_CR_MULTIJET) + (1.45*FF_CR_WJETS);
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (-0.18*FF_CR_MULTIJET) + (1.18*FF_CR_WJETS);
			 if(pt < 200) return (0.0499999999999*FF_CR_MULTIJET) + (0.95*FF_CR_WJETS);
...
float GetFFCombined_1down(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (0.51*FF_CR_MULTIJET) + (0.49*FF_CR_WJETS);
			 if(pt < 200) return (-0.0300000000001*FF_CR_MULTIJET) + (1.03*FF_CR_WJETS);
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (0.21*FF_CR_MULTIJET) + (0.79*FF_CR_WJETS);
			 ...
			 if(pt < 200) return (1.48*FF_CR_MULTIJET) + (-0.48*FF_CR_WJETS);
			 if(pt < 3500) return (1.83*FF_CR_MULTIJET) + (-0.83*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2001) {
		 if(ntracks==1){
			 if(pt < 40) return (-0.73*FF_CR_MULTIJET) + (1.73*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-8.52651282912e-14*FF_CR_MULTIJET) + (1.0*FF_CR_WJETS);
			 if(pt < 3500) return (-0.64*FF_CR_MULTIJET) + (1.64*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2002) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (-0.4*FF_CR_MULTIJET) + (1.4*FF_CR_WJETS);
			 if(pt < 200) return (-0.69*FF_CR_MULTIJET) + (1.69*FF_CR_WJETS);
			 if(pt < 3500) return (-1.12*FF_CR_MULTIJET) + (2.12*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2003) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.41*FF_CR_MULTIJET) + (2.41*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (-0.23*FF_CR_MULTIJET) + (1.23*FF_CR_WJETS);
	 ...
	 if (index==2007) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-1.12*FF_CR_MULTIJET) + (2.12*FF_CR_WJETS);
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 if(pt < 40) return (0.93*FF_CR_MULTIJET) + (0.0700000000001*FF_CR_WJETS);
			 ...
			 if(pt < 80) return (1.01*FF_CR_MULTIJET) + (-0.00999999999989*FF_CR_WJETS);
	 ...
	 if (index==2000) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-0.32*FF_CR_MULTIJET) + (1.32*FF_CR_WJETS);
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 if(pt < 40) return (-1.04*FF_CR_MULTIJET) + (2.04*FF_CR_WJETS);
