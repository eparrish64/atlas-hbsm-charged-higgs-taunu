...
float GetFFCombined_NOMINAL(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-2.26*FF_CR_MULTIJET) + (3.26*FF_CR_WJETS);
			 if(pt < 100) return (-2.52*FF_CR_MULTIJET) + (3.52*FF_CR_WJETS);
			 if(pt < 3500) return (-1.86*FF_CR_MULTIJET) + (2.86*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 if(pt < 45) return (-0.64*FF_CR_MULTIJET) + (1.64*FF_CR_WJETS);
			 ...
			 if(pt < 100) return (0.5*FF_CR_MULTIJET) + (0.5*FF_CR_WJETS);
			 if(pt < 200) return (1.08*FF_CR_MULTIJET) + (-0.0799999999999*FF_CR_WJETS);
			 if(pt < 3500) return (0.0999999999999*FF_CR_MULTIJET) + (0.9*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (-2.16*FF_CR_MULTIJET) + (3.16*FF_CR_WJETS);
			 if(pt < 80) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (0.66*FF_CR_MULTIJET) + (0.34*FF_CR_WJETS);
			 if(pt < 60) return (0.77*FF_CR_MULTIJET) + (0.23*FF_CR_WJETS);
			 if(pt < 80) return (1.33*FF_CR_MULTIJET) + (-0.33*FF_CR_WJETS);
			 if(pt < 100) return (1.65*FF_CR_MULTIJET) + (-0.65*FF_CR_WJETS);
			 if(pt < 200) return (3.37*FF_CR_MULTIJET) + (-2.37*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-1.64*FF_CR_MULTIJET) + (2.64*FF_CR_WJETS);
			 if(pt < 3500) return (-1.79*FF_CR_MULTIJET) + (2.79*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 if(pt < 45) return (-0.41*FF_CR_MULTIJET) + (1.41*FF_CR_WJETS);
			 if(pt < 50) return (-0.34*FF_CR_MULTIJET) + (1.34*FF_CR_WJETS);
			 if(pt < 60) return (-0.46*FF_CR_MULTIJET) + (1.46*FF_CR_WJETS);
			 if(pt < 80) return (-0.42*FF_CR_MULTIJET) + (1.42*FF_CR_WJETS);
			 if(pt < 100) return (-0.54*FF_CR_MULTIJET) + (1.54*FF_CR_WJETS);
			 if(pt < 200) return (-3.42*FF_CR_MULTIJET) + (4.42*FF_CR_WJETS);
			 if(pt < 3500) return (0.62*FF_CR_MULTIJET) + (0.38*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (-1.59*FF_CR_MULTIJET) + (2.59*FF_CR_WJETS);
			 if(pt < 80) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 if(pt < 100) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 if(pt < 3500) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 else return 0;
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (1.6*FF_CR_MULTIJET) + (-0.6*FF_CR_WJETS);
			 if(pt < 3500) return (0.71*FF_CR_MULTIJET) + (0.29*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (-0.21*FF_CR_MULTIJET) + (1.21*FF_CR_WJETS);
			 if(pt < 60) return (-0.64*FF_CR_MULTIJET) + (1.64*FF_CR_WJETS);
			 if(pt < 80) return (-3.39*FF_CR_MULTIJET) + (4.39*FF_CR_WJETS);
			 if(pt < 100) return (-3.41*FF_CR_MULTIJET) + (4.41*FF_CR_WJETS);
			 if(pt < 3500) return (-4.29*FF_CR_MULTIJET) + (5.29*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1005) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-1.33*FF_CR_MULTIJET) + (2.33*FF_CR_WJETS);
			 if(pt < 3500) return (-1.23*FF_CR_MULTIJET) + (2.23*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2001) {
		 if(ntracks==1){
			 if(pt < 40) return (-0.85*FF_CR_MULTIJET) + (1.85*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-2.15*FF_CR_MULTIJET) + (3.15*FF_CR_WJETS);
			 if(pt < 100) return (-2.03*FF_CR_MULTIJET) + (3.03*FF_CR_WJETS);
			 if(pt < 3500) return (-3.36*FF_CR_MULTIJET) + (4.36*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2002) {
		 ...
		 if(ntracks==3){
			 if(pt < 40) return (-0.5*FF_CR_MULTIJET) + (1.5*FF_CR_WJETS);
			 if(pt < 60) return (-0.62*FF_CR_MULTIJET) + (1.62*FF_CR_WJETS);
			 if(pt < 80) return (-1.92*FF_CR_MULTIJET) + (2.92*FF_CR_WJETS);
	 ...
	 if (index==2003) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-2.18*FF_CR_MULTIJET) + (3.18*FF_CR_WJETS);
			 if(pt < 100) return (-1.84*FF_CR_MULTIJET) + (2.84*FF_CR_WJETS);
			 if(pt < 3500) return (-2.75*FF_CR_MULTIJET) + (3.75*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2004) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-0.26*FF_CR_MULTIJET) + (1.26*FF_CR_WJETS);
	 ...
	 if (index==2005) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (1.07*FF_CR_MULTIJET) + (-0.0699999999999*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2007) {
		 if(ntracks==1){
			 if(pt < 40) return (1.34*FF_CR_MULTIJET) + (-0.34*FF_CR_WJETS);
			 if(pt < 45) return (1.27*FF_CR_MULTIJET) + (-0.27*FF_CR_WJETS);
			 if(pt < 50) return (0.89*FF_CR_MULTIJET) + (0.11*FF_CR_WJETS);
			 if(pt < 60) return (1.12*FF_CR_MULTIJET) + (-0.12*FF_CR_WJETS);
			 if(pt < 80) return (1.33*FF_CR_MULTIJET) + (-0.33*FF_CR_WJETS);
			 if(pt < 100) return (0.78*FF_CR_MULTIJET) + (0.22*FF_CR_WJETS);
			 if(pt < 200) return (-0.49*FF_CR_MULTIJET) + (1.49*FF_CR_WJETS);
			 if(pt < 3500) return (0.21*FF_CR_MULTIJET) + (0.79*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (0.91*FF_CR_MULTIJET) + (0.0900000000001*FF_CR_WJETS);
			 if(pt < 60) return (0.66*FF_CR_MULTIJET) + (0.34*FF_CR_WJETS);
			 if(pt < 80) return (1.72*FF_CR_MULTIJET) + (-0.72*FF_CR_WJETS);
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 if(pt < 40) return (1.22*FF_CR_MULTIJET) + (-0.22*FF_CR_WJETS);
			 if(pt < 45) return (1.08*FF_CR_MULTIJET) + (-0.0799999999999*FF_CR_WJETS);
			 if(pt < 50) return (0.9*FF_CR_MULTIJET) + (0.1*FF_CR_WJETS);
			 if(pt < 60) return (1.02*FF_CR_MULTIJET) + (-0.0199999999999*FF_CR_WJETS);
			 if(pt < 80) return (1.09*FF_CR_MULTIJET) + (-0.0899999999999*FF_CR_WJETS);
			 if(pt < 100) return (0.67*FF_CR_MULTIJET) + (0.33*FF_CR_WJETS);
			 if(pt < 200) return (0.14*FF_CR_MULTIJET) + (0.86*FF_CR_WJETS);
			 if(pt < 3500) return (1.59*FF_CR_MULTIJET) + (-0.59*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (0.81*FF_CR_MULTIJET) + (0.19*FF_CR_WJETS);
			 if(pt < 60) return (0.62*FF_CR_MULTIJET) + (0.38*FF_CR_WJETS);
			 if(pt < 80) return (1.86*FF_CR_MULTIJET) + (-0.86*FF_CR_WJETS);
			 if(pt < 100) return (1.97*FF_CR_MULTIJET) + (-0.97*FF_CR_WJETS);
	 ...
	 if (index==2009) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.25*FF_CR_MULTIJET) + (1.25*FF_CR_WJETS);
			 ...
			 if(pt < 3500) return (-1.37*FF_CR_MULTIJET) + (2.37*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2000) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-0.61*FF_CR_MULTIJET) + (1.61*FF_CR_WJETS);
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 if(pt < 40) return (-1.12*FF_CR_MULTIJET) + (2.12*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-2.43*FF_CR_MULTIJET) + (3.43*FF_CR_WJETS);
			 if(pt < 100) return (-2.42*FF_CR_MULTIJET) + (3.42*FF_CR_WJETS);
			 if(pt < 3500) return (-2.78*FF_CR_MULTIJET) + (3.78*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
...
float GetFFCombined_1up(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (0.9*FF_CR_MULTIJET) + (0.1*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-1.24*FF_CR_MULTIJET) + (2.24*FF_CR_WJETS);
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (1.36*FF_CR_MULTIJET) + (-0.36*FF_CR_WJETS);
			 if(pt < 200) return (2.29*FF_CR_MULTIJET) + (-1.29*FF_CR_WJETS);
			 if(pt < 3500) return (2.4*FF_CR_MULTIJET) + (-1.4*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (-1.5*FF_CR_MULTIJET) + (2.5*FF_CR_WJETS);
			 if(pt < 80) return (-4.28*FF_CR_MULTIJET) + (5.28*FF_CR_WJETS);
			 if(pt < 100) return (-4.36*FF_CR_MULTIJET) + (5.36*FF_CR_WJETS);
			 if(pt < 3500) return (-4.59*FF_CR_MULTIJET) + (5.59*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (1.6*FF_CR_MULTIJET) + (-0.6*FF_CR_WJETS);
			 if(pt < 100) return (2.16*FF_CR_MULTIJET) + (-1.16*FF_CR_WJETS);
			 if(pt < 200) return (4.52*FF_CR_MULTIJET) + (-3.52*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-0.71*FF_CR_MULTIJET) + (1.71*FF_CR_WJETS);
			 if(pt < 3500) return (-0.71*FF_CR_MULTIJET) + (1.71*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 if(pt < 45) return (-0.23*FF_CR_MULTIJET) + (1.23*FF_CR_WJETS);
			 ...
			 if(pt < 100) return (-0.25*FF_CR_MULTIJET) + (1.25*FF_CR_WJETS);
			 if(pt < 200) return (-1.43*FF_CR_MULTIJET) + (2.43*FF_CR_WJETS);
			 if(pt < 3500) return (1.64*FF_CR_MULTIJET) + (-0.64*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (-1.29*FF_CR_MULTIJET) + (2.29*FF_CR_WJETS);
			 if(pt < 80) return (-4.21*FF_CR_MULTIJET) + (5.21*FF_CR_WJETS);
			 if(pt < 100) return (-3.58*FF_CR_MULTIJET) + (4.58*FF_CR_WJETS);
			 if(pt < 3500) return (-4.16*FF_CR_MULTIJET) + (5.16*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (0.3*FF_CR_MULTIJET) + (0.7*FF_CR_WJETS);
			 ...
			 if(pt < 200) return (1.97*FF_CR_MULTIJET) + (-0.97*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-2.42*FF_CR_MULTIJET) + (3.42*FF_CR_WJETS);
			 if(pt < 100) return (-2.23*FF_CR_MULTIJET) + (3.23*FF_CR_WJETS);
			 if(pt < 3500) return (-2.69*FF_CR_MULTIJET) + (3.69*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 if(pt < 45) return (0.64*FF_CR_MULTIJET) + (0.36*FF_CR_WJETS);
			 ...
			 if(pt < 100) return (1.19*FF_CR_MULTIJET) + (-0.19*FF_CR_WJETS);
	 ...
	 if (index==2001) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.44*FF_CR_MULTIJET) + (1.44*FF_CR_WJETS);
			 ...
			 if(pt < 3500) return (0.87*FF_CR_MULTIJET) + (0.13*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (-0.28*FF_CR_MULTIJET) + (1.28*FF_CR_WJETS);
			 if(pt < 60) return (-0.54*FF_CR_MULTIJET) + (1.54*FF_CR_WJETS);
			 if(pt < 80) return (-1.45*FF_CR_MULTIJET) + (2.45*FF_CR_WJETS);
	 ...
	 if (index==2002) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.4*FF_CR_MULTIJET) + (1.4*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-1.16*FF_CR_MULTIJET) + (2.16*FF_CR_WJETS);
			 if(pt < 100) return (-1.12*FF_CR_MULTIJET) + (2.12*FF_CR_WJETS);
			 if(pt < 3500) return (-1.86*FF_CR_MULTIJET) + (2.86*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==2003) {
		 if(ntracks==1){
			 if(pt < 40) return (-0.76*FF_CR_MULTIJET) + (1.76*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-1.38*FF_CR_MULTIJET) + (2.38*FF_CR_WJETS);
	 ...
	 if (index==2004) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (0.17*FF_CR_MULTIJET) + (0.83*FF_CR_WJETS);
			 if(pt < 50) return (0.18*FF_CR_MULTIJET) + (0.82*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 60) return (-0.0700000000001*FF_CR_MULTIJET) + (1.07*FF_CR_WJETS);
			 if(pt < 80) return (-0.17*FF_CR_MULTIJET) + (1.17*FF_CR_WJETS);
			 if(pt < 100) return (0.22*FF_CR_MULTIJET) + (0.78*FF_CR_WJETS);
			 if(pt < 3500) return (0.0999999999999*FF_CR_MULTIJET) + (0.9*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==2007) {
		 if(ntracks==1){
			 if(pt < 40) return (1.52*FF_CR_MULTIJET) + (-0.52*FF_CR_WJETS);
			 if(pt < 45) return (1.42*FF_CR_MULTIJET) + (-0.42*FF_CR_WJETS);
			 if(pt < 50) return (1.02*FF_CR_MULTIJET) + (-0.0199999999999*FF_CR_WJETS);
			 if(pt < 60) return (1.27*FF_CR_MULTIJET) + (-0.27*FF_CR_WJETS);
			 if(pt < 80) return (1.55*FF_CR_MULTIJET) + (-0.55*FF_CR_WJETS);
			 if(pt < 100) return (1.16*FF_CR_MULTIJET) + (-0.16*FF_CR_WJETS);
			 if(pt < 200) return (0.11*FF_CR_MULTIJET) + (0.89*FF_CR_WJETS);
			 if(pt < 3500) return (1.16*FF_CR_MULTIJET) + (-0.16*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (1.16*FF_CR_MULTIJET) + (-0.16*FF_CR_WJETS);
			 if(pt < 60) return (0.79*FF_CR_MULTIJET) + (0.21*FF_CR_WJETS);
			 if(pt < 80) return (2.23*FF_CR_MULTIJET) + (-1.23*FF_CR_WJETS);
			 if(pt < 100) return (1.92*FF_CR_MULTIJET) + (-0.92*FF_CR_WJETS);
			 if(pt < 3500) return (1.87*FF_CR_MULTIJET) + (-0.87*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 if(pt < 40) return (1.39*FF_CR_MULTIJET) + (-0.39*FF_CR_WJETS);
			 if(pt < 45) return (1.23*FF_CR_MULTIJET) + (-0.23*FF_CR_WJETS);
			 if(pt < 50) return (1.03*FF_CR_MULTIJET) + (-0.0299999999999*FF_CR_WJETS);
			 if(pt < 60) return (1.16*FF_CR_MULTIJET) + (-0.16*FF_CR_WJETS);
			 if(pt < 80) return (1.3*FF_CR_MULTIJET) + (-0.3*FF_CR_WJETS);
			 if(pt < 100) return (1.01*FF_CR_MULTIJET) + (-0.00999999999987*FF_CR_WJETS);
			 if(pt < 200) return (0.7*FF_CR_MULTIJET) + (0.3*FF_CR_WJETS);
			 if(pt < 3500) return (1.59*FF_CR_MULTIJET) + (-0.59*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (2.37*FF_CR_MULTIJET) + (-1.37*FF_CR_WJETS);
			 if(pt < 100) return (2.71*FF_CR_MULTIJET) + (-1.71*FF_CR_WJETS);
			 if(pt < 3500) return (2.08*FF_CR_MULTIJET) + (-1.08*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (-0.26*FF_CR_MULTIJET) + (1.26*FF_CR_WJETS);
			 if(pt < 100) return (-0.1*FF_CR_MULTIJET) + (1.1*FF_CR_WJETS);
			 if(pt < 200) return (0.62*FF_CR_MULTIJET) + (0.38*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-1.45*FF_CR_MULTIJET) + (2.45*FF_CR_WJETS);
			 if(pt < 100) return (-1.25*FF_CR_MULTIJET) + (2.25*FF_CR_WJETS);
			 if(pt < 3500) return (-1.34*FF_CR_MULTIJET) + (2.34*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
...
float GetFFCombined_1down(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 ...
		 if(ntracks==3){
			 if(pt < 60) return (-0.65*FF_CR_MULTIJET) + (1.65*FF_CR_WJETS);
			 if(pt < 80) return (-3.71*FF_CR_MULTIJET) + (4.71*FF_CR_WJETS);
			 if(pt < 100) return (-4.59*FF_CR_MULTIJET) + (5.59*FF_CR_WJETS);
			 if(pt < 3500) return (-4.12*FF_CR_MULTIJET) + (5.12*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 if(pt < 45) return (-1.0*FF_CR_MULTIJET) + (2.0*FF_CR_WJETS);
			 if(pt < 50) return (-0.79*FF_CR_MULTIJET) + (1.79*FF_CR_WJETS);
			 ...
			 if(pt < 200) return (-0.0900000000001*FF_CR_MULTIJET) + (1.09*FF_CR_WJETS);
			 if(pt < 3500) return (-2.82*FF_CR_MULTIJET) + (3.82*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (-2.86*FF_CR_MULTIJET) + (3.86*FF_CR_WJETS);
			 if(pt < 80) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 if(pt < 100) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 if(pt < 3500) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 else return 0;
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (1.08*FF_CR_MULTIJET) + (-0.0799999999999*FF_CR_WJETS);
			 if(pt < 100) return (1.18*FF_CR_MULTIJET) + (-0.18*FF_CR_WJETS);
			 if(pt < 200) return (2.49*FF_CR_MULTIJET) + (-1.49*FF_CR_WJETS);
			 if(pt < 3500) return (-0.0300000000001*FF_CR_MULTIJET) + (1.03*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (-0.24*FF_CR_MULTIJET) + (1.24*FF_CR_WJETS);
			 if(pt < 80) return (-1.6*FF_CR_MULTIJET) + (2.6*FF_CR_WJETS);
			 if(pt < 100) return (-3.13*FF_CR_MULTIJET) + (4.13*FF_CR_WJETS);
			 if(pt < 3500) return (-4.2*FF_CR_MULTIJET) + (5.2*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1003) {
		 ...
		 if(ntracks==3){
			 if(pt < 60) return (-1.91*FF_CR_MULTIJET) + (2.91*FF_CR_WJETS);
			 if(pt < 80) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 if(pt < 100) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 if(pt < 3500) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 else return 0;
	 ...
	 if (index==1005) {
		 ...
		 if(ntracks==3){
			 if(pt < 60) return (-0.23*FF_CR_MULTIJET) + (1.23*FF_CR_WJETS);
			 if(pt < 80) return (-1.96*FF_CR_MULTIJET) + (2.96*FF_CR_WJETS);
			 if(pt < 100) return (-2.64*FF_CR_MULTIJET) + (3.64*FF_CR_WJETS);
			 if(pt < 3500) return (-2.93*FF_CR_MULTIJET) + (3.93*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2001) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-0.67*FF_CR_MULTIJET) + (1.67*FF_CR_WJETS);
			 if(pt < 3500) return (-2.03*FF_CR_MULTIJET) + (3.03*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (-0.86*FF_CR_MULTIJET) + (1.86*FF_CR_WJETS);
			 if(pt < 60) return (-0.85*FF_CR_MULTIJET) + (1.85*FF_CR_WJETS);
			 if(pt < 80) return (-3.2*FF_CR_MULTIJET) + (4.2*FF_CR_WJETS);
			 if(pt < 100) return (-3.54*FF_CR_MULTIJET) + (4.54*FF_CR_WJETS);
			 if(pt < 3500) return (-3.36*FF_CR_MULTIJET) + (4.36*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==2002) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.69*FF_CR_MULTIJET) + (1.69*FF_CR_WJETS);
			 if(pt < 50) return (-0.46*FF_CR_MULTIJET) + (1.46*FF_CR_WJETS);
			 if(pt < 60) return (-0.51*FF_CR_MULTIJET) + (1.51*FF_CR_WJETS);
			 if(pt < 80) return (-0.47*FF_CR_MULTIJET) + (1.47*FF_CR_WJETS);
			 if(pt < 100) return (-0.52*FF_CR_MULTIJET) + (1.52*FF_CR_WJETS);
			 if(pt < 200) return (-1.08*FF_CR_MULTIJET) + (2.08*FF_CR_WJETS);
			 if(pt < 3500) return (-4.32*FF_CR_MULTIJET) + (5.32*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (-0.89*FF_CR_MULTIJET) + (1.89*FF_CR_WJETS);
			 if(pt < 60) return (-0.81*FF_CR_MULTIJET) + (1.81*FF_CR_WJETS);
			 if(pt < 80) return (-3.03*FF_CR_MULTIJET) + (4.03*FF_CR_WJETS);
			 if(pt < 100) return (-3.84*FF_CR_MULTIJET) + (4.84*FF_CR_WJETS);
			 if(pt < 3500) return (-3.32*FF_CR_MULTIJET) + (4.32*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==2003) {
		 if(ntracks==1){
			 if(pt < 40) return (-1.11*FF_CR_MULTIJET) + (2.11*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 if(pt < 40) return (-0.93*FF_CR_MULTIJET) + (1.93*FF_CR_WJETS);
			 if(pt < 60) return (-0.9*FF_CR_MULTIJET) + (1.9*FF_CR_WJETS);
			 if(pt < 80) return (-3.34*FF_CR_MULTIJET) + (4.34*FF_CR_WJETS);
			 if(pt < 100) return (-3.45*FF_CR_MULTIJET) + (4.45*FF_CR_WJETS);
			 if(pt < 3500) return (-2.75*FF_CR_MULTIJET) + (3.75*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==2004) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-0.63*FF_CR_MULTIJET) + (1.63*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 60) return (-0.3*FF_CR_MULTIJET) + (1.3*FF_CR_WJETS);
			 if(pt < 80) return (-1.08*FF_CR_MULTIJET) + (2.08*FF_CR_WJETS);
	 ...
	 if (index==2005) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-3.13*FF_CR_MULTIJET) + (4.13*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (-0.33*FF_CR_MULTIJET) + (1.33*FF_CR_WJETS);
	 ...
	 if (index==2007) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (0.76*FF_CR_MULTIJET) + (0.24*FF_CR_WJETS);
			 if(pt < 60) return (0.98*FF_CR_MULTIJET) + (0.0200000000001*FF_CR_WJETS);
			 if(pt < 80) return (1.12*FF_CR_MULTIJET) + (-0.12*FF_CR_WJETS);
			 if(pt < 100) return (0.41*FF_CR_MULTIJET) + (0.59*FF_CR_WJETS);
			 if(pt < 200) return (-1.24*FF_CR_MULTIJET) + (2.24*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (1.29*FF_CR_MULTIJET) + (-0.29*FF_CR_WJETS);
			 if(pt < 100) return (0.75*FF_CR_MULTIJET) + (0.25*FF_CR_WJETS);
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 ...
			 if(pt < 60) return (0.88*FF_CR_MULTIJET) + (0.12*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 if(pt < 40) return (0.6*FF_CR_MULTIJET) + (0.4*FF_CR_WJETS);
			 if(pt < 60) return (0.5*FF_CR_MULTIJET) + (0.5*FF_CR_WJETS);
			 if(pt < 80) return (1.45*FF_CR_MULTIJET) + (-0.45*FF_CR_WJETS);
			 if(pt < 100) return (1.42*FF_CR_MULTIJET) + (-0.42*FF_CR_WJETS);
			 if(pt < 3500) return (0.71*FF_CR_MULTIJET) + (0.29*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==2009) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-4.33*FF_CR_MULTIJET) + (5.33*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (-0.55*FF_CR_MULTIJET) + (1.55*FF_CR_WJETS);
			 ...
			 if(pt < 100) return (-1.45*FF_CR_MULTIJET) + (2.45*FF_CR_WJETS);
	 ...
	 if (index==2000) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-0.38*FF_CR_MULTIJET) + (1.38*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-1.19*FF_CR_MULTIJET) + (2.19*FF_CR_WJETS);
			 if(pt < 100) return (-1.25*FF_CR_MULTIJET) + (2.25*FF_CR_WJETS);
			 if(pt < 3500) return (-1.99*FF_CR_MULTIJET) + (2.99*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 if(pt < 40) return (-1.35*FF_CR_MULTIJET) + (2.35*FF_CR_WJETS);
			 if(pt < 45) return (-0.97*FF_CR_MULTIJET) + (1.97*FF_CR_WJETS);
			 if(pt < 50) return (-0.6*FF_CR_MULTIJET) + (1.6*FF_CR_WJETS);
			 if(pt < 60) return (-0.77*FF_CR_MULTIJET) + (1.77*FF_CR_WJETS);
			 if(pt < 80) return (-0.6*FF_CR_MULTIJET) + (1.6*FF_CR_WJETS);
			 if(pt < 100) return (-0.68*FF_CR_MULTIJET) + (1.68*FF_CR_WJETS);
			 if(pt < 200) return (-0.92*FF_CR_MULTIJET) + (1.92*FF_CR_WJETS);
			 if(pt < 3500) return (-2.04*FF_CR_MULTIJET) + (3.04*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (-1.44*FF_CR_MULTIJET) + (2.44*FF_CR_WJETS);
			 if(pt < 60) return (-1.11*FF_CR_MULTIJET) + (2.11*FF_CR_WJETS);
			 if(pt < 80) return (-3.87*FF_CR_MULTIJET) + (4.87*FF_CR_WJETS);
			 if(pt < 100) return (-4.35*FF_CR_MULTIJET) + (5.35*FF_CR_WJETS);
			 if(pt < 3500) return (-2.78*FF_CR_MULTIJET) + (3.78*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
