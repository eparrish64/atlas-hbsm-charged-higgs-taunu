...
float GetFFCombined_NOMINAL(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (2.65*FF_CR_MULTIJET) + (-1.65*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (0.93*FF_CR_MULTIJET) + (0.0700000000001*FF_CR_WJETS);
			 if(pt < 3500) return (2.46*FF_CR_MULTIJET) + (-1.46*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (0.99*FF_CR_MULTIJET) + (0.0100000000001*FF_CR_WJETS);
			 if(pt < 100) return (1.21*FF_CR_MULTIJET) + (-0.21*FF_CR_WJETS);
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (1.48*FF_CR_MULTIJET) + (-0.48*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (0.2*FF_CR_MULTIJET) + (0.8*FF_CR_WJETS);
			 if(pt < 100) return (0.37*FF_CR_MULTIJET) + (0.63*FF_CR_WJETS);
			 if(pt < 200) return (2.09*FF_CR_MULTIJET) + (-1.09*FF_CR_WJETS);
	 ...
	 //! Combined FFs for (bveto100) target region
	 if (index==1006) {
		 if(ntracks==1){
			 if(pt < 45) return (0.81*FF_CR_MULTIJET) + (0.19*FF_CR_WJETS);
			 if(pt < 50) return (0.69*FF_CR_MULTIJET) + (0.31*FF_CR_WJETS);
			 if(pt < 60) return (0.89*FF_CR_MULTIJET) + (0.11*FF_CR_WJETS);
			 if(pt < 80) return (1.36*FF_CR_MULTIJET) + (-0.36*FF_CR_WJETS);
			 if(pt < 100) return (1.74*FF_CR_MULTIJET) + (-0.74*FF_CR_WJETS);
			 if(pt < 200) return (3.99*FF_CR_MULTIJET) + (-2.99*FF_CR_WJETS);
			 if(pt < 3500) return (2.8*FF_CR_MULTIJET) + (-1.8*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1009) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (1.7*FF_CR_MULTIJET) + (-0.7*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (0.72*FF_CR_MULTIJET) + (0.28*FF_CR_WJETS);
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 if(pt < 45) return (0.32*FF_CR_MULTIJET) + (0.68*FF_CR_WJETS);
			 if(pt < 50) return (0.47*FF_CR_MULTIJET) + (0.53*FF_CR_WJETS);
			 if(pt < 60) return (0.45*FF_CR_MULTIJET) + (0.55*FF_CR_WJETS);
			 if(pt < 80) return (0.65*FF_CR_MULTIJET) + (0.35*FF_CR_WJETS);
			 if(pt < 100) return (0.88*FF_CR_MULTIJET) + (0.12*FF_CR_WJETS);
			 if(pt < 200) return (0.24*FF_CR_MULTIJET) + (0.76*FF_CR_WJETS);
			 if(pt < 3500) return (2.29*FF_CR_MULTIJET) + (-1.29*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2007) {
		 if(ntracks==1){
			 if(pt < 40) return (1.01*FF_CR_MULTIJET) + (-0.00999999999989*FF_CR_WJETS);
			 if(pt < 45) return (0.91*FF_CR_MULTIJET) + (0.0900000000001*FF_CR_WJETS);
			 if(pt < 50) return (0.73*FF_CR_MULTIJET) + (0.27*FF_CR_WJETS);
			 if(pt < 60) return (0.96*FF_CR_MULTIJET) + (0.0400000000001*FF_CR_WJETS);
			 if(pt < 80) return (1.25*FF_CR_MULTIJET) + (-0.25*FF_CR_WJETS);
			 if(pt < 100) return (0.96*FF_CR_MULTIJET) + (0.0400000000001*FF_CR_WJETS);
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 if(pt < 40) return (0.95*FF_CR_MULTIJET) + (0.0500000000001*FF_CR_WJETS);
			 if(pt < 45) return (0.87*FF_CR_MULTIJET) + (0.13*FF_CR_WJETS);
			 if(pt < 50) return (0.78*FF_CR_MULTIJET) + (0.22*FF_CR_WJETS);
			 if(pt < 60) return (0.78*FF_CR_MULTIJET) + (0.22*FF_CR_WJETS);
			 if(pt < 80) return (1.19*FF_CR_MULTIJET) + (-0.19*FF_CR_WJETS);
			 if(pt < 100) return (1.23*FF_CR_MULTIJET) + (-0.23*FF_CR_WJETS);
			 if(pt < 200) return (0.15*FF_CR_MULTIJET) + (0.85*FF_CR_WJETS);
	 ...
	 if (index==2020) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (0.0699999999999*FF_CR_MULTIJET) + (0.93*FF_CR_WJETS);
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.81*FF_CR_MULTIJET) + (1.81*FF_CR_WJETS);
...
float GetFFCombined_1up(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (0.62*FF_CR_MULTIJET) + (0.38*FF_CR_WJETS);
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (0.72*FF_CR_MULTIJET) + (0.28*FF_CR_WJETS);
			 if(pt < 200) return (1.7*FF_CR_MULTIJET) + (-0.7*FF_CR_WJETS);
			 if(pt < 3500) return (2.46*FF_CR_MULTIJET) + (-1.46*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (0.6*FF_CR_MULTIJET) + (0.4*FF_CR_WJETS);
			 if(pt < 60) return (0.72*FF_CR_MULTIJET) + (0.28*FF_CR_WJETS);
			 if(pt < 80) return (1.13*FF_CR_MULTIJET) + (-0.13*FF_CR_WJETS);
			 if(pt < 100) return (1.49*FF_CR_MULTIJET) + (-0.49*FF_CR_WJETS);
			 if(pt < 200) return (3.99*FF_CR_MULTIJET) + (-2.99*FF_CR_WJETS);
			 if(pt < 3500) return (3.9*FF_CR_MULTIJET) + (-2.9*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (1.03*FF_CR_MULTIJET) + (-0.0299999999999*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-3.39*FF_CR_MULTIJET) + (4.39*FF_CR_WJETS);
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (0.16*FF_CR_MULTIJET) + (0.84*FF_CR_WJETS);
			 ...
			 if(pt < 200) return (2.42*FF_CR_MULTIJET) + (-1.42*FF_CR_WJETS);
	 ...
	 if (index==1006) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (0.82*FF_CR_MULTIJET) + (0.18*FF_CR_WJETS);
			 if(pt < 60) return (1.01*FF_CR_MULTIJET) + (-0.00999999999989*FF_CR_WJETS);
			 if(pt < 80) return (1.53*FF_CR_MULTIJET) + (-0.53*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (0.84*FF_CR_MULTIJET) + (0.16*FF_CR_WJETS);
	 ...
	 if (index==1009) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (1.19*FF_CR_MULTIJET) + (-0.19*FF_CR_WJETS);
			 if(pt < 50) return (1.1*FF_CR_MULTIJET) + (-0.0999999999999*FF_CR_WJETS);
			 if(pt < 60) return (1.35*FF_CR_MULTIJET) + (-0.35*FF_CR_WJETS);
			 ...
			 if(pt < 3500) return (1.88*FF_CR_MULTIJET) + (-0.88*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2004) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (0.12*FF_CR_MULTIJET) + (0.88*FF_CR_WJETS);
	 ...
	 if (index==2007) {
		 if(ntracks==1){
			 ...
			 if(pt < 60) return (1.05*FF_CR_MULTIJET) + (-0.0499999999999*FF_CR_WJETS);
			 if(pt < 80) return (1.39*FF_CR_MULTIJET) + (-0.39*FF_CR_WJETS);
			 if(pt < 100) return (1.18*FF_CR_MULTIJET) + (-0.18*FF_CR_WJETS);
			 if(pt < 200) return (-0.37*FF_CR_MULTIJET) + (1.37*FF_CR_WJETS);
			 if(pt < 3500) return (3.63*FF_CR_MULTIJET) + (-2.63*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (0.4*FF_CR_MULTIJET) + (0.6*FF_CR_WJETS);
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 ...
			 if(pt < 60) return (0.86*FF_CR_MULTIJET) + (0.14*FF_CR_WJETS);
			 if(pt < 80) return (1.31*FF_CR_MULTIJET) + (-0.31*FF_CR_WJETS);
			 if(pt < 100) return (1.44*FF_CR_MULTIJET) + (-0.44*FF_CR_WJETS);
			 if(pt < 200) return (0.48*FF_CR_MULTIJET) + (0.52*FF_CR_WJETS);
	 ...
	 if (index==2020) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (0.0999999999999*FF_CR_MULTIJET) + (0.9*FF_CR_WJETS);
			 if(pt < 60) return (0.0399999999999*FF_CR_MULTIJET) + (0.96*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (0.0799999999999*FF_CR_MULTIJET) + (0.92*FF_CR_WJETS);
			 if(pt < 100) return (0.13*FF_CR_MULTIJET) + (0.87*FF_CR_WJETS);
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 if(pt < 40) return (-0.98*FF_CR_MULTIJET) + (1.98*FF_CR_WJETS);
			 if(pt < 45) return (-0.71*FF_CR_MULTIJET) + (1.71*FF_CR_WJETS);
			 if(pt < 50) return (-0.39*FF_CR_MULTIJET) + (1.39*FF_CR_WJETS);
			 if(pt < 60) return (-0.46*FF_CR_MULTIJET) + (1.46*FF_CR_WJETS);
...
float GetFFCombined_1down(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (0.0799999999999*FF_CR_MULTIJET) + (0.92*FF_CR_WJETS);
			 if(pt < 100) return (0.3*FF_CR_MULTIJET) + (0.7*FF_CR_WJETS);
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 60) return (-0.72*FF_CR_MULTIJET) + (1.72*FF_CR_WJETS);
			 if(pt < 80) return (-0.65*FF_CR_MULTIJET) + (1.65*FF_CR_WJETS);
			 if(pt < 100) return (-0.33*FF_CR_MULTIJET) + (1.33*FF_CR_WJETS);
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (0.84*FF_CR_MULTIJET) + (0.16*FF_CR_WJETS);
			 if(pt < 100) return (0.96*FF_CR_MULTIJET) + (0.0400000000001*FF_CR_WJETS);
			 if(pt < 200) return (3.69*FF_CR_MULTIJET) + (-2.69*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (0.54*FF_CR_MULTIJET) + (0.46*FF_CR_WJETS);
			 if(pt < 100) return (0.49*FF_CR_MULTIJET) + (0.51*FF_CR_WJETS);
			 if(pt < 3500) return (0.83*FF_CR_MULTIJET) + (0.17*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 if(pt < 45) return (-0.56*FF_CR_MULTIJET) + (1.56*FF_CR_WJETS);
			 ...
			 if(pt < 200) return (-4.0*FF_CR_MULTIJET) + (5.0*FF_CR_WJETS);
			 if(pt < 3500) return (1.14*FF_CR_MULTIJET) + (-0.14*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (1.82*FF_CR_MULTIJET) + (-0.82*FF_CR_WJETS);
	 ...
	 if (index==1006) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (1.19*FF_CR_MULTIJET) + (-0.19*FF_CR_WJETS);
			 if(pt < 100) return (1.43*FF_CR_MULTIJET) + (-0.43*FF_CR_WJETS);
			 if(pt < 200) return (3.85*FF_CR_MULTIJET) + (-2.85*FF_CR_WJETS);
			 if(pt < 3500) return (1.84*FF_CR_MULTIJET) + (-0.84*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (0.58*FF_CR_MULTIJET) + (0.42*FF_CR_WJETS);
	 ...
	 if (index==1009) {
		 if(ntracks==1){
			 if(pt < 40) return (1.29*FF_CR_MULTIJET) + (-0.29*FF_CR_WJETS);
			 if(pt < 45) return (1.1*FF_CR_MULTIJET) + (-0.0999999999999*FF_CR_WJETS);
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (0.56*FF_CR_MULTIJET) + (0.44*FF_CR_WJETS);
			 if(pt < 100) return (0.73*FF_CR_MULTIJET) + (0.27*FF_CR_WJETS);
	 ...
	 if (index==2001) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (-0.66*FF_CR_MULTIJET) + (1.66*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2002) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-0.79*FF_CR_MULTIJET) + (1.79*FF_CR_WJETS);
	 ...
	 if (index==2004) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (-0.16*FF_CR_MULTIJET) + (1.16*FF_CR_WJETS);
			 if(pt < 200) return (-0.37*FF_CR_MULTIJET) + (1.37*FF_CR_WJETS);
			 if(pt < 3500) return (-1.69*FF_CR_MULTIJET) + (2.69*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (-8.52651282912e-14*FF_CR_MULTIJET) + (1.0*FF_CR_WJETS);
	 ...
	 if (index==2005) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (-0.27*FF_CR_MULTIJET) + (1.27*FF_CR_WJETS);
			 if(pt < 200) return (-0.33*FF_CR_MULTIJET) + (1.33*FF_CR_WJETS);
			 if(pt < 3500) return (-2.17*FF_CR_MULTIJET) + (3.17*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2007) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 60) return (0.37*FF_CR_MULTIJET) + (0.63*FF_CR_WJETS);
			 if(pt < 80) return (0.49*FF_CR_MULTIJET) + (0.51*FF_CR_WJETS);
			 if(pt < 100) return (0.35*FF_CR_MULTIJET) + (0.65*FF_CR_WJETS);
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 if(pt < 40) return (0.86*FF_CR_MULTIJET) + (0.14*FF_CR_WJETS);
			 if(pt < 45) return (0.79*FF_CR_MULTIJET) + (0.21*FF_CR_WJETS);
			 if(pt < 50) return (0.71*FF_CR_MULTIJET) + (0.29*FF_CR_WJETS);
			 if(pt < 60) return (0.7*FF_CR_MULTIJET) + (0.3*FF_CR_WJETS);
			 if(pt < 80) return (1.07*FF_CR_MULTIJET) + (-0.0699999999999*FF_CR_WJETS);
			 if(pt < 100) return (1.03*FF_CR_MULTIJET) + (-0.0299999999999*FF_CR_WJETS);
	 ...
	 if (index==2009) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-0.51*FF_CR_MULTIJET) + (1.51*FF_CR_WJETS);
			 if(pt < 3500) return (-1.83*FF_CR_MULTIJET) + (2.83*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2020) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (0.0399999999999*FF_CR_MULTIJET) + (0.96*FF_CR_WJETS);
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 if(pt < 40) return (-1.24*FF_CR_MULTIJET) + (2.24*FF_CR_WJETS);
			 ...
			 if(pt < 100) return (-0.44*FF_CR_MULTIJET) + (1.44*FF_CR_WJETS);
			 if(pt < 200) return (-0.7*FF_CR_MULTIJET) + (1.7*FF_CR_WJETS);
			 if(pt < 3500) return (-1.07*FF_CR_MULTIJET) + (2.07*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
