...
float GetFFCombined_NOMINAL(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1009) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (0.83*FF_CR_MULTIJET) + (0.17*FF_CR_WJETS);
	 ...
	 if (index==1006) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (1.42*FF_CR_MULTIJET) + (-0.42*FF_CR_WJETS);
	 ...
	 if (index==2001) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.65*FF_CR_MULTIJET) + (1.65*FF_CR_WJETS);
...
float GetFFCombined_1up(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (1.19*FF_CR_MULTIJET) + (-0.19*FF_CR_WJETS);
			 if(pt < 3500) return (1.2*FF_CR_MULTIJET) + (-0.2*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
...
float GetFFCombined_1down(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1006) {
		 if(ntracks==1){
			 ...
			 if(pt < 60) return (0.8*FF_CR_MULTIJET) + (0.2*FF_CR_WJETS);
			 if(pt < 80) return (1.24*FF_CR_MULTIJET) + (-0.24*FF_CR_WJETS);
			 if(pt < 3500) return (0.74*FF_CR_MULTIJET) + (0.26*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.95*FF_CR_MULTIJET) + (1.95*FF_CR_WJETS);
