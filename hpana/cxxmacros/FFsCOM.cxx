...
float GetFFCombined_NOMINAL(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (0.5*FF_CR_MULTIJET) + (0.5*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 if(pt < 45) return (0.53*FF_CR_MULTIJET) + (0.47*FF_CR_WJETS);
			 ...
			 if(pt < 3500) return (1.01*FF_CR_MULTIJET) + (-0.00999999999989*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1000) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (0.38*FF_CR_MULTIJET) + (0.62*FF_CR_WJETS);
	 ...
	 if (index==1006) {
		 ...
		 if(ntracks==3){
			 if(pt < 60) return (0.61*FF_CR_MULTIJET) + (0.39*FF_CR_WJETS);
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 if(pt < 45) return (0.33*FF_CR_MULTIJET) + (0.67*FF_CR_WJETS);
	 ...
	 if (index==2001) {
		 if(ntracks==1){
			 if(pt < 40) return (-0.79*FF_CR_MULTIJET) + (1.79*FF_CR_WJETS);
	 ...
	 if (index==2008) {
		 if(ntracks==1){
			 if(pt < 40) return (0.96*FF_CR_MULTIJET) + (0.0400000000001*FF_CR_WJETS);
	 ...
	 if (index==2021) {
		 if(ntracks==1){
			 if(pt < 40) return (-1.09*FF_CR_MULTIJET) + (2.09*FF_CR_WJETS);
...
float GetFFCombined_1up(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (1.21*FF_CR_MULTIJET) + (-0.21*FF_CR_WJETS);
	 ...
	 if (index==1009) {
		 if(ntracks==1){
			 if(pt < 40) return (1.43*FF_CR_MULTIJET) + (-0.43*FF_CR_WJETS);
			 if(pt < 45) return (1.21*FF_CR_MULTIJET) + (-0.21*FF_CR_WJETS);
			 if(pt < 50) return (1.11*FF_CR_MULTIJET) + (-0.11*FF_CR_WJETS);
			 if(pt < 60) return (1.36*FF_CR_MULTIJET) + (-0.36*FF_CR_WJETS);
			 if(pt < 80) return (2.01*FF_CR_MULTIJET) + (-1.01*FF_CR_WJETS);
			 if(pt < 3500) return (-0.1*FF_CR_MULTIJET) + (1.1*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (0.63*FF_CR_MULTIJET) + (0.37*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1006) {
		 if(ntracks==1){
			 if(pt < 45) return (0.97*FF_CR_MULTIJET) + (0.0300000000001*FF_CR_WJETS);
			 if(pt < 50) return (0.8*FF_CR_MULTIJET) + (0.2*FF_CR_WJETS);
			 if(pt < 60) return (1.03*FF_CR_MULTIJET) + (-0.0299999999999*FF_CR_WJETS);
			 if(pt < 80) return (1.61*FF_CR_MULTIJET) + (-0.61*FF_CR_WJETS);
			 if(pt < 3500) return (0.92*FF_CR_MULTIJET) + (0.0800000000001*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2005) {
		 if(ntracks==1){
			 if(pt < 40) return (-0.19*FF_CR_MULTIJET) + (1.19*FF_CR_WJETS);
			 if(pt < 45) return (-0.12*FF_CR_MULTIJET) + (1.12*FF_CR_WJETS);
...
float GetFFCombined_1down(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (-0.76*FF_CR_MULTIJET) + (1.76*FF_CR_WJETS);
	 ...
	 if (index==1009) {
		 if(ntracks==1){
			 if(pt < 40) return (1.27*FF_CR_MULTIJET) + (-0.27*FF_CR_WJETS);
			 ...
			 if(pt < 80) return (1.84*FF_CR_MULTIJET) + (-0.84*FF_CR_WJETS);
			 if(pt < 3500) return (-0.33*FF_CR_MULTIJET) + (1.33*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (0.85*FF_CR_MULTIJET) + (0.15*FF_CR_WJETS);
	 ...
	 if (index==1006) {
		 if(ntracks==1){
			 if(pt < 45) return (0.65*FF_CR_MULTIJET) + (0.35*FF_CR_WJETS);
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (0.54*FF_CR_MULTIJET) + (0.46*FF_CR_WJETS);
			 if(pt < 3500) return (0.28*FF_CR_MULTIJET) + (0.72*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2001) {
		 if(ntracks==1){
			 if(pt < 40) return (-0.91*FF_CR_MULTIJET) + (1.91*FF_CR_WJETS);
	 ...
	 if (index==2021) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.98*FF_CR_MULTIJET) + (1.98*FF_CR_WJETS);
			 if(pt < 50) return (-0.64*FF_CR_MULTIJET) + (1.64*FF_CR_WJETS);
			 if(pt < 60) return (-0.67*FF_CR_MULTIJET) + (1.67*FF_CR_WJETS);
	 ...
	 if (index==2011) {
		 if(ntracks==1){
			 if(pt < 40) return (-1.23*FF_CR_MULTIJET) + (2.23*FF_CR_WJETS);
