...
float GetFFCombined_NOMINAL(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (0.38*FF_CR_MULTIJET) + (0.62*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1002) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-1.02*FF_CR_MULTIJET) + (2.02*FF_CR_WJETS);
	 ...
	 if (index==1003) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-0.77*FF_CR_MULTIJET) + (1.77*FF_CR_WJETS);
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (0.53*FF_CR_MULTIJET) + (0.47*FF_CR_WJETS);
			 if(pt < 200) return (0.51*FF_CR_MULTIJET) + (0.49*FF_CR_WJETS);
	 ...
	 if (index==2007) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (1.01*FF_CR_MULTIJET) + (-0.00999999999987*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
...
float GetFFCombined_1up(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==2011) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-0.63*FF_CR_MULTIJET) + (1.63*FF_CR_WJETS);
			 if(pt < 3500) return (-0.54*FF_CR_MULTIJET) + (1.54*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
...
float GetFFCombined_1down(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1002) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-1.57*FF_CR_MULTIJET) + (2.57*FF_CR_WJETS);
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (0.58*FF_CR_MULTIJET) + (0.42*FF_CR_WJETS);
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.66*FF_CR_MULTIJET) + (2.66*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==2002) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 60) return (-0.17*FF_CR_MULTIJET) + (1.17*FF_CR_WJETS);
			 if(pt < 80) return (-0.44*FF_CR_MULTIJET) + (1.44*FF_CR_WJETS);
			 if(pt < 100) return (-0.7*FF_CR_MULTIJET) + (1.7*FF_CR_WJETS);
			 if(pt < 3500) return (-0.76*FF_CR_MULTIJET) + (1.76*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==2003) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-0.66*FF_CR_MULTIJET) + (1.66*FF_CR_WJETS);
	 ...
	 if (index==2004) {
		 if(ntracks==1){
			 if(pt < 40) return (-0.0100000000001*FF_CR_MULTIJET) + (1.01*FF_CR_WJETS);
			 if(pt < 45) return (0.00999999999989*FF_CR_MULTIJET) + (0.99*FF_CR_WJETS);
