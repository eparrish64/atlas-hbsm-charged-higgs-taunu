...
float GetFFCombined_NOMINAL(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (0.64*FF_CR_MULTIJET) + (0.36*FF_CR_WJETS);
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (0.85*FF_CR_MULTIJET) + (0.15*FF_CR_WJETS);
			 if(pt < 100) return (0.83*FF_CR_MULTIJET) + (0.17*FF_CR_WJETS);
			 if(pt < 200) return (1.24*FF_CR_MULTIJET) + (-0.24*FF_CR_WJETS);
			 if(pt < 3500) return (1.4*FF_CR_MULTIJET) + (-0.4*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (0.45*FF_CR_MULTIJET) + (0.55*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (1.95*FF_CR_MULTIJET) + (-0.95*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (0.0199999999999*FF_CR_MULTIJET) + (0.98*FF_CR_WJETS);
			 if(pt < 80) return (-0.84*FF_CR_MULTIJET) + (1.84*FF_CR_WJETS);
			 if(pt < 100) return (-1.59*FF_CR_MULTIJET) + (2.59*FF_CR_WJETS);
			 if(pt < 3500) return (-1.97*FF_CR_MULTIJET) + (2.97*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (-0.94*FF_CR_MULTIJET) + (1.94*FF_CR_WJETS);
			 if(pt < 60) return (-0.75*FF_CR_MULTIJET) + (1.75*FF_CR_WJETS);
			 if(pt < 80) return (-0.74*FF_CR_MULTIJET) + (1.74*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 if(pt < 60) return (-0.5*FF_CR_MULTIJET) + (1.5*FF_CR_WJETS);
			 if(pt < 80) return (-1.44*FF_CR_MULTIJET) + (2.44*FF_CR_WJETS);
			 if(pt < 100) return (-1.35*FF_CR_MULTIJET) + (2.35*FF_CR_WJETS);
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (0.00999999999989*FF_CR_MULTIJET) + (0.99*FF_CR_WJETS);
			 if(pt < 3500) return (-1.39*FF_CR_MULTIJET) + (2.39*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (-0.75*FF_CR_MULTIJET) + (1.75*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1013) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-0.39*FF_CR_MULTIJET) + (1.39*FF_CR_WJETS);
	 ...
	 if (index==1014) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (0.0399999999999*FF_CR_MULTIJET) + (0.96*FF_CR_WJETS);
			 if(pt < 3500) return (-1.06581410364e-13*FF_CR_MULTIJET) + (1.0*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1010) {
		 if(ntracks==1){
			 if(pt < 40) return (0.56*FF_CR_MULTIJET) + (0.44*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (1.79*FF_CR_MULTIJET) + (-0.79*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1006) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.29*FF_CR_MULTIJET) + (2.29*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1011) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.14*FF_CR_MULTIJET) + (2.14*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (1.41*FF_CR_MULTIJET) + (-0.41*FF_CR_WJETS);
...
float GetFFCombined_UP(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 ...
			 if(pt < 60) return (0.85*FF_CR_MULTIJET) + (0.15*FF_CR_WJETS);
			 if(pt < 80) return (0.99*FF_CR_MULTIJET) + (0.0100000000001*FF_CR_WJETS);
			 if(pt < 100) return (0.89*FF_CR_MULTIJET) + (0.11*FF_CR_WJETS);
			 if(pt < 200) return (1.09*FF_CR_MULTIJET) + (-0.0899999999999*FF_CR_WJETS);
			 if(pt < 3500) return (0.59*FF_CR_MULTIJET) + (0.41*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (0.84*FF_CR_MULTIJET) + (0.16*FF_CR_WJETS);
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (1.28*FF_CR_MULTIJET) + (-0.28*FF_CR_WJETS);
			 if(pt < 200) return (1.69*FF_CR_MULTIJET) + (-0.69*FF_CR_WJETS);
			 if(pt < 3500) return (1.85*FF_CR_MULTIJET) + (-0.85*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 if(pt < 45) return (0.38*FF_CR_MULTIJET) + (0.62*FF_CR_WJETS);
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.22*FF_CR_MULTIJET) + (2.22*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (0.0399999999999*FF_CR_MULTIJET) + (0.96*FF_CR_WJETS);
			 if(pt < 80) return (-0.9*FF_CR_MULTIJET) + (1.9*FF_CR_WJETS);
			 if(pt < 100) return (-0.81*FF_CR_MULTIJET) + (1.81*FF_CR_WJETS);
			 if(pt < 3500) return (-2.59*FF_CR_MULTIJET) + (3.59*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (1.13*FF_CR_MULTIJET) + (-0.13*FF_CR_WJETS);
			 if(pt < 60) return (1.28*FF_CR_MULTIJET) + (-0.28*FF_CR_WJETS);
	 ...
	 if (index==1013) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (0.36*FF_CR_MULTIJET) + (0.64*FF_CR_WJETS);
	 ...
	 if (index==1014) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (0.55*FF_CR_MULTIJET) + (0.45*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1010) {
		 if(ntracks==1){
			 if(pt < 40) return (1.01*FF_CR_MULTIJET) + (-0.00999999999987*FF_CR_WJETS);
			 if(pt < 45) return (1.01*FF_CR_MULTIJET) + (-0.00999999999987*FF_CR_WJETS);
			 ...
			 if(pt < 200) return (0.85*FF_CR_MULTIJET) + (0.15*FF_CR_WJETS);
			 if(pt < 3500) return (-0.52*FF_CR_MULTIJET) + (1.52*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (1.08*FF_CR_MULTIJET) + (-0.0799999999999*FF_CR_WJETS);
			 if(pt < 60) return (1.08*FF_CR_MULTIJET) + (-0.0799999999999*FF_CR_WJETS);
			 if(pt < 80) return (1.68*FF_CR_MULTIJET) + (-0.68*FF_CR_WJETS);
			 if(pt < 100) return (1.94*FF_CR_MULTIJET) + (-0.94*FF_CR_WJETS);
			 if(pt < 3500) return (2.33*FF_CR_MULTIJET) + (-1.33*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1008) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (0.47*FF_CR_MULTIJET) + (0.53*FF_CR_WJETS);
			 if(pt < 50) return (0.51*FF_CR_MULTIJET) + (0.49*FF_CR_WJETS);
			 if(pt < 60) return (0.48*FF_CR_MULTIJET) + (0.52*FF_CR_WJETS);
	 ...
	 if (index==1011) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (0.87*FF_CR_MULTIJET) + (0.13*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (1.74*FF_CR_MULTIJET) + (-0.74*FF_CR_WJETS);
			 if(pt < 100) return (1.95*FF_CR_MULTIJET) + (-0.95*FF_CR_WJETS);
			 if(pt < 3500) return (2.24*FF_CR_MULTIJET) + (-1.24*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
...
float GetFFCombined_DOWN(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1000) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-0.52*FF_CR_MULTIJET) + (1.52*FF_CR_WJETS);
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (0.79*FF_CR_MULTIJET) + (0.21*FF_CR_WJETS);
	 ...
	 if (index==1003) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (-2.51*FF_CR_MULTIJET) + (3.51*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 if(pt < 45) return (-1.37*FF_CR_MULTIJET) + (2.37*FF_CR_WJETS);
			 if(pt < 50) return (-1.39*FF_CR_MULTIJET) + (2.39*FF_CR_WJETS);
			 if(pt < 60) return (-1.2*FF_CR_MULTIJET) + (2.2*FF_CR_WJETS);
			 if(pt < 80) return (-1.19*FF_CR_MULTIJET) + (2.19*FF_CR_WJETS);
			 if(pt < 100) return (-0.92*FF_CR_MULTIJET) + (1.92*FF_CR_WJETS);
			 if(pt < 200) return (-1.02*FF_CR_MULTIJET) + (2.02*FF_CR_WJETS);
			 if(pt < 3500) return (-2.12*FF_CR_MULTIJET) + (3.12*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (-1.04*FF_CR_MULTIJET) + (2.04*FF_CR_WJETS);
			 if(pt < 80) return (-1.98*FF_CR_MULTIJET) + (2.98*FF_CR_WJETS);
			 if(pt < 100) return (-1.89*FF_CR_MULTIJET) + (2.89*FF_CR_WJETS);
			 if(pt < 3500) return (-3.67*FF_CR_MULTIJET) + (4.67*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 if(pt < 40) return (0.29*FF_CR_MULTIJET) + (0.71*FF_CR_WJETS);
	 ...
	 if (index==1007) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-0.66*FF_CR_MULTIJET) + (1.66*FF_CR_WJETS);
			 if(pt < 100) return (-0.92*FF_CR_MULTIJET) + (1.92*FF_CR_WJETS);
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.84*FF_CR_MULTIJET) + (2.84*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-0.87*FF_CR_MULTIJET) + (1.87*FF_CR_WJETS);
			 if(pt < 3500) return (-1.29*FF_CR_MULTIJET) + (2.29*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==1013) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-0.54*FF_CR_MULTIJET) + (1.54*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-0.93*FF_CR_MULTIJET) + (1.93*FF_CR_WJETS);
			 if(pt < 100) return (-0.96*FF_CR_MULTIJET) + (1.96*FF_CR_WJETS);
	 ...
	 if (index==1006) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (-0.51*FF_CR_MULTIJET) + (1.51*FF_CR_WJETS);
			 if(pt < 200) return (-0.43*FF_CR_MULTIJET) + (1.43*FF_CR_WJETS);
			 if(pt < 3500) return (-1.74*FF_CR_MULTIJET) + (2.74*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1011) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.59*FF_CR_MULTIJET) + (2.59*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
