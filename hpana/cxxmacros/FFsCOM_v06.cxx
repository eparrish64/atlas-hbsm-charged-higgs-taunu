...
float GetFFCombined_NOMINAL(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (-0.72*FF_CR_MULTIJET) + (1.72*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-2.46*FF_CR_MULTIJET) + (3.46*FF_CR_WJETS);
			 if(pt < 100) return (-2.02*FF_CR_MULTIJET) + (3.02*FF_CR_WJETS);
	 ...
	 if (index==1002) {
		 if(ntracks==1){
			 ...
			 if(pt < 80) return (0.95*FF_CR_MULTIJET) + (0.0500000000001*FF_CR_WJETS);
			 if(pt < 100) return (1.04*FF_CR_MULTIJET) + (-0.0399999999999*FF_CR_WJETS);
			 if(pt < 200) return (1.54*FF_CR_MULTIJET) + (-0.54*FF_CR_WJETS);
	 ...
	 if (index==1003) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-1.5*FF_CR_MULTIJET) + (2.5*FF_CR_WJETS);
			 if(pt < 100) return (-1.93*FF_CR_MULTIJET) + (2.93*FF_CR_WJETS);
			 if(pt < 3500) return (-5.0*FF_CR_MULTIJET) + (6.0*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==1004) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (-1.55*FF_CR_MULTIJET) + (2.55*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1012) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.19*FF_CR_MULTIJET) + (1.19*FF_CR_WJETS);
	 ...
	 if (index==1005) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 3500) return (-1.28*FF_CR_MULTIJET) + (2.28*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1007) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (0.0299999999999*FF_CR_MULTIJET) + (0.97*FF_CR_WJETS);
			 if(pt < 3500) return (0.11*FF_CR_MULTIJET) + (0.89*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1010) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.11*FF_CR_MULTIJET) + (2.11*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 40) return (0.53*FF_CR_MULTIJET) + (0.47*FF_CR_WJETS);
			 if(pt < 60) return (0.54*FF_CR_MULTIJET) + (0.46*FF_CR_WJETS);
			 if(pt < 80) return (1.03*FF_CR_MULTIJET) + (-0.0299999999999*FF_CR_WJETS);
...
float GetFFCombined_UP(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1000) {
		 if(ntracks==1){
			 if(pt < 45) return (0.77*FF_CR_MULTIJET) + (0.23*FF_CR_WJETS);
			 ...
			 if(pt < 200) return (1.3*FF_CR_MULTIJET) + (-0.3*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (0.73*FF_CR_MULTIJET) + (0.27*FF_CR_WJETS);
			 if(pt < 3500) return (0.25*FF_CR_MULTIJET) + (0.75*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1001) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-1.48*FF_CR_MULTIJET) + (2.48*FF_CR_WJETS);
	 ...
	 if (index==1003) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-0.96*FF_CR_MULTIJET) + (1.96*FF_CR_WJETS);
			 if(pt < 100) return (-1.39*FF_CR_MULTIJET) + (2.39*FF_CR_WJETS);
			 if(pt < 3500) return (-4.46*FF_CR_MULTIJET) + (5.46*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==1004) {
		 ...
		 if(ntracks==3){
			 if(pt < 40) return (0.35*FF_CR_MULTIJET) + (0.65*FF_CR_WJETS);
			 if(pt < 60) return (0.32*FF_CR_MULTIJET) + (0.68*FF_CR_WJETS);
			 if(pt < 80) return (0.16*FF_CR_MULTIJET) + (0.84*FF_CR_WJETS);
			 if(pt < 100) return (0.24*FF_CR_MULTIJET) + (0.76*FF_CR_WJETS);
	 ...
	 if (index==1012) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (0.26*FF_CR_MULTIJET) + (0.74*FF_CR_WJETS);
	 ...
	 if (index==1009) {
		 ...
		 if(ntracks==3){
			 if(pt < 40) return (1.14*FF_CR_MULTIJET) + (-0.14*FF_CR_WJETS);
	 ...
	 if (index==1005) {
		 if(ntracks==1){
			 ...
			 if(pt < 100) return (0.34*FF_CR_MULTIJET) + (0.66*FF_CR_WJETS);
			 if(pt < 200) return (0.38*FF_CR_MULTIJET) + (0.62*FF_CR_WJETS);
			 if(pt < 3500) return (-0.9*FF_CR_MULTIJET) + (1.9*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1010) {
		 if(ntracks==1){
			 if(pt < 40) return (1.0*FF_CR_MULTIJET) + (1.27897692437e-13*FF_CR_WJETS);
			 ...
			 if(pt < 80) return (1.1*FF_CR_MULTIJET) + (-0.0999999999999*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (1.57*FF_CR_MULTIJET) + (-0.57*FF_CR_WJETS);
			 if(pt < 100) return (1.54*FF_CR_MULTIJET) + (-0.54*FF_CR_WJETS);
			 if(pt < 3500) return (2.78*FF_CR_MULTIJET) + (-1.78*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
...
float GetFFCombined_DOWN(float pt, int ntracks, float FF_CR_MULTIJET, float FF_CR_WJETS, int index){
	 ...
	 if (index==1001) {
		 if(ntracks==1){
			 ...
			 if(pt < 50) return (-1.17*FF_CR_MULTIJET) + (2.17*FF_CR_WJETS);
			 if(pt < 60) return (-0.82*FF_CR_MULTIJET) + (1.82*FF_CR_WJETS);
			 if(pt < 80) return (-1.06*FF_CR_MULTIJET) + (2.06*FF_CR_WJETS);
			 if(pt < 100) return (-0.92*FF_CR_MULTIJET) + (1.92*FF_CR_WJETS);
			 if(pt < 200) return (-1.06*FF_CR_MULTIJET) + (2.06*FF_CR_WJETS);
			 if(pt < 3500) return (-1.82*FF_CR_MULTIJET) + (2.82*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (-1.39*FF_CR_MULTIJET) + (2.39*FF_CR_WJETS);
			 if(pt < 80) return (-3.0*FF_CR_MULTIJET) + (4.0*FF_CR_WJETS);
			 if(pt < 100) return (-2.56*FF_CR_MULTIJET) + (3.56*FF_CR_WJETS);
	 ...
	 if (index==1003) {
		 if(ntracks==1){
			 ...
			 if(pt < 200) return (-1.05*FF_CR_MULTIJET) + (2.05*FF_CR_WJETS);
			 if(pt < 3500) return (1.14*FF_CR_MULTIJET) + (-0.14*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
			 if(pt < 60) return (-0.75*FF_CR_MULTIJET) + (1.75*FF_CR_WJETS);
			 if(pt < 80) return (-2.04*FF_CR_MULTIJET) + (3.04*FF_CR_WJETS);
			 if(pt < 100) return (-2.47*FF_CR_MULTIJET) + (3.47*FF_CR_WJETS);
			 if(pt < 3500) return (-5.53452248382*FF_CR_MULTIJET) + (6.53452248382*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 ...
	 if (index==1006) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 60) return (-0.79*FF_CR_MULTIJET) + (1.79*FF_CR_WJETS);
			 if(pt < 80) return (-0.81*FF_CR_MULTIJET) + (1.81*FF_CR_WJETS);
			 if(pt < 100) return (-0.68*FF_CR_MULTIJET) + (1.68*FF_CR_WJETS);
			 if(pt < 3500) return (-1.92*FF_CR_MULTIJET) + (2.92*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1004) {
		 if(ntracks==1){
			 ...
			 if(pt < 45) return (-0.7*FF_CR_MULTIJET) + (1.7*FF_CR_WJETS);
			 if(pt < 50) return (-0.64*FF_CR_MULTIJET) + (1.64*FF_CR_WJETS);
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-0.92*FF_CR_MULTIJET) + (1.92*FF_CR_WJETS);
			 if(pt < 100) return (-0.84*FF_CR_MULTIJET) + (1.84*FF_CR_WJETS);
			 if(pt < 3500) return (-2.09*FF_CR_MULTIJET) + (3.09*FF_CR_WJETS);
			 else return 0;
		 }
		 else return 0;
	 }
	 ...
	 if (index==1012) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-2.23*FF_CR_MULTIJET) + (3.23*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1009) {
		 if(ntracks==1){
			 ...
			 if(pt < 3500) return (-1.02*FF_CR_MULTIJET) + (2.02*FF_CR_WJETS);
			 else return 0;
		 }
		 if(ntracks==3){
	 ...
	 if (index==1005) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 80) return (-0.95*FF_CR_MULTIJET) + (1.95*FF_CR_WJETS);
			 if(pt < 100) return (-0.73*FF_CR_MULTIJET) + (1.73*FF_CR_WJETS);
			 if(pt < 3500) return (-1.82*FF_CR_MULTIJET) + (2.82*FF_CR_WJETS);
			 else return 0;
		 }
	 ...
	 if (index==1008) {
		 ...
		 if(ntracks==3){
			 ...
			 if(pt < 100) return (-0.69*FF_CR_MULTIJET) + (1.69*FF_CR_WJETS);
