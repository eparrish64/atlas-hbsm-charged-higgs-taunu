...
def get_sample_variation_weight(systematic, variation, dataset, sample, channel):
  ...
  if channel == "taujet":
    ...
    for wts in wtaunu_samples:
      ...
      specialSampleVariations[wts]["wtaunu_pdf"] = {}
      specialSampleVariations[wts]["wtaunu_pdf"]["wtaunu_pdf_1up"] = "(weight_mc+{})/weight_mc".format(errString)
      specialSampleVariations[wts]["wtaunu_pdf"]["wtaunu_pdf_1down"] = "(weight_mc-{})/weight_mc".format(errString)
  # End if
